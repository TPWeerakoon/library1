		...
		<form method="post" action="" name="form1">
            ...
            <select name="username" required>
                ...
                <?php
                    ...
                    $res=mysqli_query($db,"SELECT student.username,roll,books.bid,name,authors,edition,status FROM student inner join issue_book ON student.username=issue_book.username inner join books ON issue_book.bid=books.bid WHERE issue_book.approve =''");
