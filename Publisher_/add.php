...
<div id="main">
  ...
  <div class="container" style="text-align: center;">
    <h2 style="color:black; font-family: Lucida Console; text-align: center"><b>Request New Books</b></h2>
    ...
    <form class="book" action="" method="post">
        ...
        <input type="number" min="1" step="1" name="quantity" class="form-control" placeholder="Quantity" required=""><br>
