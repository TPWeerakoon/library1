    ...
    $c=0;
      ...
      while($row=mysqli_fetch_assoc($res))
      {
        echo "<tr>";
          ...
          echo "<td>"; if($row['approve']=='EXPIRED'){ echo '<p style="color:yellow; background-color:red;">EXPIRED</p>';}else if($row['approve']=='RETURNED'){ echo '<p style="color:yellow; background-color:green;">RETURNED</p>'; }else{ echo $row['approve'];} echo "</td>";
