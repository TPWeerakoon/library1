...
<?php
  ...
  {
      $results1=mysqli_query($db,"SELECT quantity from books where bid='$_SESSION[bid]'");
    ...
    if($not_available == 1){
        ...
        mysqli_query($db,"UPDATE  `issue_book` SET  `approve` =  '$_POST[approve]', `issue` =  '$_POST[issue]', `return` =  '$_POST[return]' WHERE username='$_SESSION[name]' and approve ='' and bid='$_SESSION[bid]';");
